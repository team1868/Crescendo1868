...
public class TagalongChoreo {
  private static final Gson gson = new Gson();

  /** Default constructor. */
  public TagalongChoreo() {}
   ...
   */
  public static TagalongChoreoTrajectory getTrajectory(String trajName) {
  ...
  private static TagalongChoreoTrajectory loadFile(File path) {
    try {
      var reader = new BufferedReader(new FileReader(path));
      TagalongChoreoTrajectory traj = gson.fromJson(reader, TagalongChoreoTrajectory.class);
   ...
   *     TagalongChoreoTrajectoryState referenceState) -&gt; ChassisSpeeds to implement a custom
  ...
  /**
   * Creates a control function for following a TagalongChoreoTrajectoryState.
   *
   * @param xController A PIDController for field-relative X translation (input: X error in meters,
   *     output: m/s).
   * @param yController A PIDController for field-relative Y translation (input: Y error in meters,
   ...
   *     output: rad/s). This controller will have its continuous input range set to -pi..pi by
   *     ChoreoLib.
   * @return A ChoreoControlFunction to track TagalongChoreoTrajectoryStates. This function returns
