...
public class CompbotClimberElevatorConf extends ElevatorConf {
  /* -------- Required Configurations -------- */
  private static final String name = "Climber Elevator";

  private static final Motors[] motorTypes = {Motors.KRAKEN_X60_FOC}; // primary motor is the
  // first in the list
  private static final int[] motorDeviceIDs = {46};
  private static final String[] motorCanBus = {"Default Name"};
  private static final InvertedValue[] motorDirection = {InvertedValue.Clockwise_Positive};
  ...
  private static final double drumDiameter = 1.273;

  private static final int[][] gearRatio = {{48, 14}, {47, 24}};
  ...
  private static final double trapezoidalLimitsVelocity = 1.0;
  private static final double trapezoidalLimitsAcceleration = 2.0;
  ...
  private static final double positionalMax = 0.398;

  private static final DistanceUnits defaultTolerancesUnits = DistanceUnits.METER;
  private static final double defaultLowerTolerance = 0.015;
  private static final double defaultUpperTolerance = 0.015;
  ...
  private static final double motorCurrentLimitPeakDuration = 0.8;

  private static final FeedforwardConstants feedForward =
      new FeedforwardConstants(0.103, 0.236, 7.9365079365, 0.0);
  ...
  public CompbotClimberElevatorConf(
      String name,
      Motors[] motorTypes,
      int[] motorDeviceIDs,
      String[] motorCanBus,
