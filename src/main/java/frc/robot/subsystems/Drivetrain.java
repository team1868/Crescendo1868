...
import frc.robot.subsystems.MultiCameraController.VisionState;
...
public class Drivetrain extends TagalongSubsystemBase {
  ...
  public void simulationInit() {
    if (RobotAltModes.isSim && !_isSubsystemDisabled) {
  ...
  // CRUCIAL
  // TODO: Depending on april tags seen, return true if valid stage tag for a given alliance is seen
  ...
  private void snapToAngleDrive(
    ...
    var theta =
        clamp(_angleController.calculate(getYaw().getRadians()), -maxAngularSpeed, maxAngularSpeed);
    fieldRelativeDrive(
        xTranslationalMPS,
        yTranslationalMPS,
