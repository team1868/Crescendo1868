...
public class TagalongSwerveModuleBase {
  ...
  protected void setDesiredSteer() {
    ...
    // TODO: Reuse the position voltage object rather than creating a new one each
    // time
  ...
  public void updateShuffleboard() {
    ...
    if (RobotAltModes.isModuleTuningMode) {
      ...
      // _driveMotor.setControl(new
      // VelocityVoltage(0.0).withFeedForward(_feedforward.ks));
    }
  }
