...
public class GeometricUtils {
  ...
  public static double placeInClosestRot(double scopeReferenceRad, double newAngleRad) {
    return Units.degreesToRotations(placeInClosestScopeDeg(
        Units.rotationsToDegrees(scopeReferenceRad), Units.rotationsToDegrees(newAngleRad)
    ));
  }
}
