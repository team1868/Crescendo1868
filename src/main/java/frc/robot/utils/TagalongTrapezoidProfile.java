 ...
 */
public class TagalongTrapezoidProfile {
   ...
   */
  public TagalongTrapezoidProfile(
   ...
   * @param goal The desired state when the profile is complete.
   */
  public TagalongTrapezoidProfile(TrapezoidProfile.Constraints constraints, State goal) {
