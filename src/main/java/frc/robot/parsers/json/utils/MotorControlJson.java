...
public class MotorControlJson {
  ...
  public Slot0Configs getSlot0() {
    if (slot0 == null) {
      slot0 =
          RobotAltModes.isSim ? simMotor.getSlot0Configuration() : motor.getSlot0Configuration();
    }
    return slot0;
  }
  ...
  public Slot1Configs getSlot1() {
    if (slot1 == null) {
      slot1 =
          RobotAltModes.isSim ? simMotor.getSlot1Configuration() : motor.getSlot1Configuration();
    }
    return slot1;
  }
  ...
  public Slot2Configs getSlot2() {
    if (slot2 == null) {
      slot2 =
          RobotAltModes.isSim ? simMotor.getSlot2Configuration() : motor.getSlot2Configuration();
    }
    return slot2;
  }
