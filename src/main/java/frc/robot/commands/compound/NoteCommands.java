...
public class NoteCommands {
    ...
    return Commands
        .deadline(
            ...
            Commands.parallel(
                ...
                shooter.getRoller().startEndRollerRPSWithFFCmd(ShotConstants.ROLLER_EJECT_RPS),
                intake.getRoller().startEndRollerRPSWithFFCmd(IntakeConstants.ROLLER_EJECT_RPS)
            )
        )
  ...
  public static Command loadNoteForSpeakerCommand(
    ...
    return Commands.sequence(
        ...
        new RollXCmd<Shooter>(
            ...
            true,
            shooter.getPivot()._maxVelocityRPS,
            lowerToleranceRot,
            upperToleranceRot
        )
    );
  ...
  public static Command loadNoteForTrapCommand(
    ...
    return Commands.sequence(
        shooter.getRoller()
            .startEndRollerRPSWithFFCmd(Shooter.ShotConstants.ROLLER_OUT_RPS)
            .until(() -> !shooter.isPieceInChute()),
        new RollXCmd<Shooter>(
            shooter,
            ShooterRollerDistances.TRAP_PREP,
            true,
            shooter.getPivot()._maxVelocityRPS,
            lowerTolerance,
            upperTolerance
    ...
    return Commands
        .sequence(
            ...
            Commands
                ...
                .deadlineWith(shooter.getRoller().startEndRollerRPSWithFFCmd(
        ...
        .finallyDo(() -> {
          shooter.getRoller(ShooterConstants.FLYWHEEL_ID).setRollerPower(0.0);
          leds.unsafeSetLEDMode(
              shooter.isPieceInChute() ? LedModes.GREEN_SOLID : LedModes.RED_SOLID, 0
          );
        });
